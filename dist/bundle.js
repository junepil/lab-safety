        ...
        while (1)
          switch (_context.n) {
            case 0:
              ...
              totalPageElement = document.querySelector(
                '.total_page, .tPageNum',
              );
              totalPage = +(totalPageElement === null ||
              totalPageElement === void 0
                ? void 0
                : totalPageElement.innerHTML);
              i = 1;
            case 1:
              if (!(i <= totalPage)) {
                _context.n = 4;
